    ...
    <div>
      <div className="acc-banner">
        <div className="breadcrumb">
          ...
          <span><Link href="/account">Trang khách hàng</Link></span>
          <span className="separator">/</span>
          <span><Link href="/account/orders">Đơn hàng của bạn</Link></span>
          <span className="separator">/</span>
            ...
            <div className="acc-content-left">
              <div className="block-acc">
                ...
                <ul>
                  ...
                  <li><Link href="/account/addresses">Sổ địa chỉ</Link></li>
                </ul>
              </div>
            </div>
            <div className="acc-content-right">
