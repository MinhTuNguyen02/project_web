...
import { fetchCategoryAPI } from '../api/index'
              ...
              {categories.map((category, index) => (
                <SwiperSlide key={index}>
                  <div className={styles.cate_item}>
                    <Link className="image" href={`/allProducts?categoryId=${category._id}`} title={category.categoryName}>
                      <img
                    ...
                    <h3 className={styles.title_cate}>
                      <Link href={`/allProducts?categoryId=${category._id}`} title={category.categoryName}>
